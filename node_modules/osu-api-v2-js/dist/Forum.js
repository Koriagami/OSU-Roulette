...
(function (Forum) {
    ...
    (function (Topic) {
         ...
         */
        async function create(forum_id, title, text, poll) {
     ...
     */
    async function getOne(forum_id) {
     ...
     */
    async function getTopicAndPosts(topic, config) {
        ...
        return await this.request("get", `forums/topics/${getId(topic)}`, { start, end, sort: config?.sort, limit: config?.limit, cursor_string: config?.cursor_string });
    }
