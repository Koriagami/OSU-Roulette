...
export declare class API {
    ...
    get route_api(): string;
    set route_api(route_api: string);
    ...
    get route_token(): string;
    set route_token(route_token: string);
    private _user?;
    ...
    readonly generateWebSocket: typeof WebSocket.generate;
