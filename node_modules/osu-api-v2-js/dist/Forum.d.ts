...
export declare namespace Forum {
    ...
    namespace Topic {
         ...
         */
        function getMultiple(this: API, config?: {
         ...
         */
        function create(this: API, forum_id: Forum["id"], title: string, text: string, poll?: {
            title: string;
     ...
     */
    function getOne(this: API, forum_id: Forum["id"]): Promise<{
     ...
     */
    function getTopicAndPosts(this: API, topic: Topic["id"] | Topic, config?: {
