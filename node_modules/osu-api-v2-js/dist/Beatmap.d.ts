...
export declare namespace Beatmap {
    ...
    namespace Extended {
        interface WithFailtimesOwners extends Extended {
            failtimes: {
                exit: number[];
                fail: number[];
            };
        ...
        interface WithFailtimesOwnersMaxcombo extends WithFailtimesOwners, WithMaxcombo {
        }
        /**
         * @obtainableFrom
         * {@link API.getBeatmap} /
         ...
         */
        interface WithFailtimesOwnersMaxcomboBeatmapset extends WithFailtimesOwnersMaxcombo {
         ...
         */
        interface WithFailtimesOwnersMaxcomboToptagids extends WithFailtimesOwnersMaxcombo {
    ...
    namespace UserTag {
         ...
         * {@link API.lookupBeatmapset}
         */
        interface WithDates extends UserTag {
         ...
         */
        function getAll(this: API): Promise<UserTag[]>;
    }
    ...
    namespace Pack {
         ...
         */
        function getOne(this: API, pack: Pack["tag"] | Pack, legacy_only?: boolean): Promise<Pack.WithBeatmapset>;
        /**
    ...
    /**
         ...
         */
    function getUserScore(this: API, beatmap: Beatmap["id"] | Beatmap, user: User["id"] | User, config?: Config): Promise<{
     ...
     */
    function getUserScores(this: API, beatmap: Beatmap["id"] | Beatmap, user: User["id"] | User, config?: Config): Promise<Score[]>;
    /**
    ...
    */
     ...
     */
    function getOne(this: API, beatmap: Beatmap["id"] | Beatmap): Promise<Extended.WithFailtimesOwnersMaxcomboBeatmapset>;
    /**
     ...
     */
    function getMultiple(this: API, beatmaps: Array<Beatmap["id"] | Beatmap>): Promise<Extended.WithFailtimesOwnersMaxcombo[]>;
    /**
     ...
     */
    function getSoloScores(this: API, beatmap: Beatmap["id"] | Beatmap, config?: Config): Promise<Score.WithUser[]>;
}
