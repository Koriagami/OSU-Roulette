...
export declare namespace Score {
    ...
    interface WithUserBeatmapBeatmapset extends Score {
     ...
     */
    function getReplay(this: API, score: Score["id"] | Score): Promise<string>;
}
export {};
