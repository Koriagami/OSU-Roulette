...
export class API {
    ...
    async refreshToken() {
        ...
        try {
            await this.getAndSetToken({ client_id: this.client_id, client_secret: this.client_secret, grant_type: "refresh_token", refresh_token: this.refresh_token }, this);
    ...
    getBeatmapSoloScores = Beatmap.getSoloScores;
    ...
    getForumTopicAndPosts = Forum.getTopicAndPosts;
    // HOME STUFF
    ...
    getMatch = Multiplayer.Match.getOne;
    /** {@inheritDoc Multiplayer.Match.getMultiple} @group Multiplayer Methods */
    getMatches = Multiplayer.Match.getMultiple;
    // NEWS STUFF
    ...
    generateWebSocket = WebSocket.generate;
    // WIKI STUFF
