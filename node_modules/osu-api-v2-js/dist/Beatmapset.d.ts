...
export declare namespace Beatmapset {
    ...
    namespace Event {
        ...
        /** @group Beatmapset Status Change */
        export type AnyBeatmapsetStatusChange = Qualify | Rank | Love | Nominate | RemoveFromLoved | Disqualify | NominationReset | NominationResetReceived;
        ...
        /** @group Discussion Change */
        export type AnyDiscussionChange = DiscussionDelete | DiscussionRestore | DiscussionPostRestore | DiscussionPostDelete | DiscussionLock | DiscussionUnlock | IssueResolve | IssueReopen;
        /** @group Kudosu Change */
        ...
        /** @group Kudosu Change */
        export type AnyKudosuChange = KudosuAllow | KudosuDeny | KudosuRecalculate | KudosuGain | KudosuLost;
