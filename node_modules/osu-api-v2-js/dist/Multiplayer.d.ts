...
export declare namespace Multiplayer {
    ...
    namespace Room {
        ...
        namespace PlaylistItem {
            ...
            interface Score extends ScoreImport.WithUser {
            ...
            function getScores(this: API, item: {
                id: number;
                room_id: number;
            } | Multiplayer.Room.PlaylistItem, limit?: number, sort?: "score_asc" | "score_desc", cursor_string?: string): Promise<{
                params: {
                    limit: number;
                    sort: string;
                };
         ...
         */
        function getMultiple(this: API, type: "playlists" | "realtime", mode: "active" | "all" | "ended" | "participated" | "owned", limit?: number, sort?: "ended" | "created", season_id?: number): Promise<Room[]>;
    }
    ...
    namespace Match {
        interface Score extends ScoreImport.OldFormat {
            created_at: Date;
            match: {
                slot: number;
                team: "none" | "red" | "blue";
         ...
         */
        function getOne(this: API, match: Info["id"] | Info, query?: {
